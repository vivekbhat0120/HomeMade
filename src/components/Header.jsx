  ...
  return (
    <header className="header">
      ...
      <div className="header__actions">
        <Link to="/wishlist" className="header__icon header__icon--wishlist" aria-label="Wishlist" style={{ position: 'relative' }}>
          <h2>Wishlist</h2>
        ...
        <Link to="/cart" className="header__icon header__icon--cart" aria-label="Cart" style={{ position: 'relative' }}>
          <h2>Cart</h2>
          <span style={{position: 'relative', display: 'inline-block'}}>
        ...
        <button className="header__icon header__icon--account" aria-label="Account"><h2>Account</h2>
